...
> = {
  fr: {
    ...
    intro: "La lecture des Nœuds lunaires dépend d'un thème précis — choisissez le profil à consulter.",
  },
  en: {
    eyebrow: "Life mission",
    heading: "Choose a profile",
    intro: "The lunar Nodes reading depends on a specific chart — choose which profile to consult.",
  },
};
...
export default async function MissionDeVieIndexPage() {
