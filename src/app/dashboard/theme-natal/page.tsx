...
> = {
  fr: {
    eyebrow: "Thème astral",
    heading: "Choisissez un profil",
    intro: "Le thème natal dépend d'une date, heure et lieu de naissance précis — choisissez le profil à consulter.",
  },
  en: {
    eyebrow: "Natal chart",
    heading: "Choose a profile",
    intro: "The natal chart depends on a specific birth date, time and place — choose which profile to consult.",
  },
};
...
export default async function ThemeNatalIndexPage() {
  ...
  if (profiles.length === 1) redirect(`/dashboard/theme-natal/${profiles[0].id}`);
