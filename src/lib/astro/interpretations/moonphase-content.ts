export const MOON_PHASE_TEXT: Record<string, string> = {
  ...
  "Premier quartier":
    "Un point de tension constructif : c'est le moment classique où des décisions et des ajustements s'imposent pour que le projet entamé à la nouvelle Lune continue d'avancer.",
