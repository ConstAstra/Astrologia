...
export const METHODOLOGY: MethodologySection[] = [
  ...
  },
  {
    ...
    body: [
      ...
      "Le 29e degré de chaque signe (\"degré anarétique\") est traditionnellement lu comme un point de tension avant le changement de signe ; nous indiquons alors précisément combien de degrés et minutes il reste avant ce changement. Les degrés dits \"critiques\" (0°/13°/26° pour les signes cardinaux, 8°/21° pour les fixes, 4°/17° pour les mutables) sont un repère traditionnel supplémentaire : plutôt qu'une correspondance au degré entier près, nous les considérons \"actifs\" dans un rayon d'1° et affichons l'écart exact au repère le plus proche — à prendre comme une nuance, jamais comme une preuve.",
    ],
  },
  {
